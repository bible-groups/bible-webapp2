  ...
  <div class="min-h-screen">
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-8">
        <h1 class="text-[1.8rem] xl:text-3xl font-bold text-gray-800 mb-4">카페신학</h1>
        <p class="text-gray-600">신학을 쉽고 편안하게 나누는 공간입니다.</p>
      </div>
...
const loadPostsFromFirebase = async () => {
  try {
    ...
    const q = query(blogsCollection, where('category', '==', '카페신학'), orderBy('createAt', 'desc'))
    ...
    console.log('Firebase에서 카페신학 데이터 로드 완료:', posts.value.length, '개')
  } catch (error) {
