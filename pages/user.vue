  ...
  <div v-if="canAccess">  <!-- 접근 권한이 있을 때만 렌더링 -->
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap">
        <div class="w-full">
          <h1 class="mb-4 text-2xl font-bold">마이페이지</h1>
          <div class="mb-4 p-4 bg-green-100 border border-green-300 rounded-md flex items-center">
            <i class="mdi mdi-account text-green-500 mr-2"></i>
