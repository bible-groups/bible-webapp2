  ...
  <div class="min-h-screen">
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-8">
        <h1 class="text-[1.8rem] xl:text-3xl font-bold text-gray-800 mb-4">성서마당</h1>
        <p class="text-gray-600">성경에 대한 다양한 의견과 생각을 나누는 공간입니다.</p>
      </div>
...
// Firebase에서 데이터 로드
onMounted(async () => {
  console.log('[PAGE] forum mounted')
...
const loadPostsFromFirebase = async () => {
  try {
    ...
    console.log('Firebase에서 성서마당 데이터 로드 완료:', posts.value.length, '개')
  } catch (error) {
